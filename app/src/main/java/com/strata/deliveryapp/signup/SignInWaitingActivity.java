...
import com.strata.deliveryapp.MainActivity;
...
public class SignInWaitingActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		delivery_person_id = auth_val.getStringExtra("DELIVERY_PERSON_ID");
		...
		linear = (RelativeLayout) findViewById(R.id.type_lay);
	...
	public void AuthenticationComplete(){
		...
		SharedPreferences preferences = getSharedPreferences("DELIVERY", Context.MODE_PRIVATE);
        SharedPreferences.Editor   editor = preferences.edit();
	    editor.putString("AUTH_TOKEN", auth_token);
	    editor.putString("NUMBER", phone_no);
	    editor.putString("DELIVERY_PERSON_ID", delivery_person_id);
